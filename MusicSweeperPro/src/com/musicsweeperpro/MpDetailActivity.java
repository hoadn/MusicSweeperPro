...
public class MpDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(MpDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(MpDetailFragment.ARG_ITEM_ID));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			//
			NavUtils.navigateUpTo(this, new Intent(this, MpListActivity.class));
			return true;
		}
